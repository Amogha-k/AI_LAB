...
def test_logic_gate(logic_gate):
    ...
    # XOR gate (requires a combination of AND, OR, and NOT gates)
        ...
        # XOR is implemented using a combination of AND, OR, and NOT
            and_result1 = mcculloch_pitts(input_pair, weights_and1, threshold)
            and_result2 = mcculloch_pitts(input_pair, weights_and2, threshold)
            or_result = mcculloch_pitts((and_result1, and_result2), weights_or, threshold)
            not_result = mcculloch_pitts((or_result,), weights_not, threshold)
